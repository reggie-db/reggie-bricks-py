...
`reggie-cv` provides tools for processing live video feeds, detecting changes between frames, and extracting visual fingerprints. It is designed for monitoring scenarios where detecting significant visual changes is required.
